...
> **项目状态：** 当前源码版本为 `v0.2.0-alpha.1` 测试版，使用 Windows App SDK 1.8 维护版本。请优先在非关键设备上试用；安装器尚未代码签名，Windows SmartScreen 可能显示警告，详见 [发布清单](docs/RELEASING.md)。
...
- 支持全屏窗口自动暂停、闲置动态屏保、立即预览、输入即时唤醒、锁屏停止和解锁恢复。
